...
if (isset($_POST['submit'])) {
    ...
    $guru_id = 'GURU' . $random_number;

    // Query untuk memasukkan data ke dalam tabel guru
    $sql = "INSERT INTO guru (guru_id, nama_guru, nip, jk_guru, nmr_guru, alamat_guru, profile) 
            VALUES ('$guru_id', '$nama_guru', '$nip', '$jk_guru', '$nmr_guru', '$alamat_guru', '$profile_name')";
